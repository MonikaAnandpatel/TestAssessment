...
public class AppTest {
	...
	public static void begin() throws Exception {
		System.setProperty("webdriver.chrome.driver",
				...
				"C:\\Users\\patel\\OneDrive\\Documents\\chromedriver.exe");
	...
	@Test
	public void loginCredentialFailure() {
		driver.get("http://localhost:7080/login");
	...
	@Test
	public void testDynamic_content() {
	...
	@Test
	public void testDynamic_controls() {
	...
	@Test
	public void testDynamic_loading() {
	...
	public void testUpload() {
		...
		chooseFileButton
				.sendKeys("C:\\Users\\patel\\Downloads\\fileuploadtest.txt");
	...
	public void testJsError() {
		...
		List<Object> errorLogs = (List<Object>) ((JavascriptExecutor) driver).executeScript("return window._phantomLogs || [];");
		if (errorLogs.size() > 0) {
